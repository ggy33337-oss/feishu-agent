            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Priority order: first consider feishu_lark_agent for Feishu/Lark native operations such as messages, docs, tables, calendars, tasks, users, chats, and file operations. "
                        "If feishu_lark_agent cannot solve the request, consider the other skills. "
